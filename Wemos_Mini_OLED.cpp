...
void Wemos_Mini_OLED::drawPixel(int16_t x, int16_t y, uint16_t color) {
...
Wemos_Mini_OLED::Wemos_Mini_OLED(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS) : Adafruit_GFX(SSD1306_LCDWIDTH, SSD1306_LCDHEIGHT) {
  cs = CS;
  rst = RST;
  dc = DC;
  sclk = SCLK;
...
Wemos_Mini_OLED::Wemos_Mini_OLED(int8_t DC, int8_t RST, int8_t CS) : Adafruit_GFX(SSD1306_LCDWIDTH, SSD1306_LCDHEIGHT) {
  dc = DC;
  rst = RST;
  cs = CS;
  hwSPI = true;
...
Wemos_Mini_OLED::Wemos_Mini_OLED(int8_t reset) :
...
void Wemos_Mini_OLED::begin(uint8_t vccstate, uint8_t i2caddr, bool reset) {
  _vccstate = vccstate;
  _i2caddr = i2caddr;
...
void Wemos_Mini_OLED::invertDisplay(uint8_t i) {
  if (i) {
...
void Wemos_Mini_OLED::ssd1306_command(uint8_t c) {
  if (sid != -1)
  {
    // SPI
#ifdef HAVE_PORTREG
...
void Wemos_Mini_OLED::startscrollright(uint8_t start, uint8_t stop){
...
// Hint, the display is 16 rows tall. To scroll the whole display, run:
// display.scrollright(0x00, 0x0F)
void Wemos_Mini_OLED::startscrollleft(uint8_t start, uint8_t stop){
...
// Hint, the display is 16 rows tall. To scroll the whole display, run:
// display.scrollright(0x00, 0x0F)
void Wemos_Mini_OLED::startscrolldiagright(uint8_t start, uint8_t stop){
...
// Hint, the display is 16 rows tall. To scroll the whole display, run:
// display.scrollright(0x00, 0x0F)
void Wemos_Mini_OLED::startscrolldiagleft(uint8_t start, uint8_t stop){
  ssd1306_command(SSD1306_SET_VERTICAL_SCROLL_AREA);
  ssd1306_command(0x00);
  ssd1306_command(SSD1306_LCDHEIGHT);
...
void Wemos_Mini_OLED::stopscroll(void){
  ssd1306_command(SSD1306_DEACTIVATE_SCROLL);
}
...
void Wemos_Mini_OLED::dim(boolean dim) {
  uint8_t contrast;
...
void Wemos_Mini_OLED::display(void) {
...
// clear everything
void Wemos_Mini_OLED::clearDisplay(void) {
  memset(buffer, 0, (SSD1306_LCDWIDTH*SSD1306_LCDHEIGHT/8));
}


inline void Wemos_Mini_OLED::fastSPIwrite(uint8_t d) {
...
void Wemos_Mini_OLED::drawFastHLine(int16_t x, int16_t y, int16_t w, uint16_t color) {
  boolean bSwap = false;
  switch(rotation) {
    case 0:
...
void Wemos_Mini_OLED::drawFastHLineInternal(int16_t x, int16_t y, int16_t w, uint16_t color) {
...
void Wemos_Mini_OLED::drawFastVLine(int16_t x, int16_t y, int16_t h, uint16_t color) {
  bool bSwap = false;
  switch(rotation) {
    case 0:
      break;
...
void Wemos_Mini_OLED::drawFastVLineInternal(int16_t x, int16_t __y, int16_t __h, uint16_t color) {
